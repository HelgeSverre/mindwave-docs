...
export default defineConfig({
    title: 'Mindwave',
    description: 'Production-Ready AI Foundation for Laravel Applications.',
    appearance: true,
    head: [
        [
            'link',
        ...
        sidebar: [
            {
                text: 'Introduction',
                items: [
                    { text: 'What is Mindwave', link: '/docs/introduction' },
            ...
            },
            {
                ...
                items: [
                    ...
                    { text: 'Document Loaders', link: '/docs/rag/documents' },
            ...
            },
            {
                text: 'Advanced',
                items: [
                    { text: 'Custom Tools', link: '/docs/advanced/tools' },
